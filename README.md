...
All three files answer the same question using the same two tools, so the only thing changing between files is how the loop itself is built.

Question asked in every files: What is the price of a laptop after applying a gold discount?
