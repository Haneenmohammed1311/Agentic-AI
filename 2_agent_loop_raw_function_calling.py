...
def ollama_chat_traced(messages):
    return ollama.chat(model=MODEL, tools=tools_for_llm, messages=messages, think=True)
...
def run_agent(question: str):
    ...
    for iteration in range(1, MAX_ITERATIONS + 1):
        ...
        try:
            ...
            observation = f"Error: {e}. Please check the argument names and values, then try again."
